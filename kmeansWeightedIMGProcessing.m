        ...
        parfor R = 1 : imgR
            for C = 1 : imgC
                ...
                if centr(3,1) < 20
                    ...
                    max_votes = max(centr(:,2));     
                    low = centr(:,2) < max_votes*0.66;
                    centr2_sup = centr(:,1).*(1-low).*centr(:,2)/max_votes;
                    centr2_low = 0.66 * centr(:,1).*(low);
                    centr2 = centr2_sup + centr2_low;                    
                    centr2(centr2>255) = 255;
                end
                img90(R,C) = centr2(3);
                img50(R,C) = centr2(2);
                img10(R,C) = centr2(1);                
